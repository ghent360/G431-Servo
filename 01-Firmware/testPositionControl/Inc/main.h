...
#define BEMF_W_Pin GPIO_PIN_11
#define BEMF_W_GPIO_Port GPIOB
#define USER_POT_Pin GPIO_PIN_12
#define USER_POT_GPIO_Port GPIOB
...
#define USER_PWM_Pin GPIO_PIN_15
#define USER_PWM_GPIO_Port GPIOA
